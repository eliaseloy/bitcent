    ...
    return (
        <Area className="bg-black py-20">
            ...
            <div className="flex flex-col md:flex-row md:justify-between items-center mt-14">
                ...
                <span className="font-bold">By:<span className="mx-1"></span><span className="text-red-500 mr-3">Elias Eloy</span></span> ® {new Date().getFullYear()} - Todos os direitos reservados
                </p>
            </div>
        </Area>
    )
